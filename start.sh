...
echo "🔐 Auth Service:       http://localhost:8079/swagger-ui.html"
echo "📊 Management Service: http://localhost:8081/swagger-ui.html"
echo "🧾 Billing Service:    http://localhost:8080/swagger-ui.html"
echo "🤖 AI Service:         http://localhost:8082/docs"
